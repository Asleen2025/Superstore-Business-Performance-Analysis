...
# Save to CSV
df.to_csv(r"C:\\Users\\Ajay asleen\\OneDrive\\Documents\Data Analytics Project\\superstore_dataset.csv", index=False)


print("✅ Superstore dataset generated and saved as 'superstore_dataset.csv'")
print(df.head(10))
